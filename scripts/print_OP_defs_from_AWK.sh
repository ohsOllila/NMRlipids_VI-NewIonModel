...
HGGLYoutname=../Headgroup_Glycerol_Order_Parameters_Simulation.def
sn1outname=../sn-1_Order_Parameters_Simulation.def
sn2outname=../sn-2_Order_Parameters_Simulation.def
