...
when compared with NMR data \cite{akutsu81,altenbach84}. This data can used to accurately asses
...
with a factor 0.8.
\todo{SAMULI: I am still not sure if this is correct and/or makes sense.}
%-----\footnote----------
...
%Secondly we evaluate the response of the head group order parameters
%to varying salt concentrations in solution
...
\todo{SAMULI: I call here concentration we used to call ''nominal'' as ''molar concentration in water''.
  I think that the ''nominal'' is not a good term for this. We need to decide how we will call this.} \\
