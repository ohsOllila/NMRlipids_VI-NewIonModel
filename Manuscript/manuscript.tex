...
in the periodic orthorhombic simulation box. The water was described using 
SPC/E \cite{Berendsen1987} model. This model has the optimal dielectric constant
to be used with ECC modified molecules \todo{Citation or discussion.} and has been 
was also used in the parametrization of ECC
