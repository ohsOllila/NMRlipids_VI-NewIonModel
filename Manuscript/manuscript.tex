...
\begin{figure}[htbp!]
  ...
  \caption{\label{fig:cacl-dens}
    ...
    All the simulations shown here have the same molar concentration of ions in water ($C_{ion}'$=350~mM).
    }
\end{figure}
