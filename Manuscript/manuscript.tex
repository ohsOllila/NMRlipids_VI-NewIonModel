...
\begin{eqnarray}
  \Gamma_w^i   &=& \Gamma_w-\Gamma_i \frac{C_w-C_w'}{C_i-C_i'} \\
...
As $\Gamma_w^i$ does not depend on the definition of the interfacial region
...
\begin{equation}\label{surfexcess}
  \Gamma_w^i=\frac{1}{2A} \left ( n_w - n_i \frac{C_w}{C_i} \right ) ,
\end{equation}
...
\begin{figure}[tbp]
  ...
  \includegraphics[width=9.0cm]{../Fig/ipython_nb/Order-parameters_exp-L14-ECCL17_q80_sig89.eps}
...
and P-N vector angle by using ECC-lipids model.}
...
see Fig.~\ref{OrderParameterCHANGESnewMODELS} and Ref.~\citenum{catte16}.
