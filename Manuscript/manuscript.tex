...
to a POPC lipid bilayer can be accurately described with classical MD simulation 
force fields, where electronic polarization is implicitly included using 
...
that the simple ternary complex model.
