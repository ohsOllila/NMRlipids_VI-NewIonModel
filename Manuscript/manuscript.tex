...
on the headgroup order parameters with submolar 
...
The headgroup order parameter response to CaCl$_2$ concentration was,
...
is used. The headgroup order parameter changes as a function of CaCl$_2$
concentration model show a good agreement between ECC-lipid model and 
