...
\subsection{Response of POPC head groups to bound charge}\label{section:boundCHARGE}
...
experiments \cite{akutsu81,altenbach84} are shown in Fig.~\ref{fig:delta_ordPar_CaCl}
...
The ECC-lipid model simulations with the ECC-ion models \cite{??}
exhibit a good agreement with the experimental changes of 
...
The density distributions of water and ions along the membrane normal
are shown in Fig.~\ref{fig:cacl-dens}.
...
the relative surface excess from Eq.~\ref{surfexcess}. The value for Calcium
in the ECC-lipid model, $\Gamma_i^w = 0.07 \pm 0.01 \rm{nm}^{-2}$, is significantly
...
description for the binding affinities of Na$^+$ and Ca$^{2+}$ ions to POPC lipid
bilayer. Furthermore, the overestimated headgroup order parameter changes of POPC in the Lipid14
...
% Numbers from simulation with 980/869mM conc. CaCl2
%The average number of contacts per lipid between \ce{Ca^{2+}} and any oxygen atom in POPC is 
