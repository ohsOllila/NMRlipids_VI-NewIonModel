...
MD simualtions (e.g.~divalent cation-induced charge inversion of bacterial membranes~\cite{Luan2016} \todo{JOE: this may be a too daring statement.}). 
...
\begin{figure*}[tbp]
  ...
  \todo{This will be replaced with new figure with surfactants and P-N vector analysis when it is done.}
\end{figure*}
...
\begin{figure}[tbp]
  ...
  \caption{\label{fig:cacl-dens}
    Profiles of normalized number density of \ce{Ca^{2+}} and \ce{Cl^-} for Lipid14 model with Dang ions
    and with ECC-ions and ECC-lipids model with ECC-ions. 
    Normalization factor for ions is 1 for monovalent ions (i.e.~\ce{Na^+} and~\ce{Cl^-}), 2 for divalent ions (i.e.~\ce{Ca^2+}), and $1/100$ for water. 
    }
