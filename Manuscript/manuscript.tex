...
or with Dang ions, $\Gamma_{\rm Ca}^w = (0.30 \pm 0.03) \rm{nm}^{-2}$,
or with ECC-ions,  $\Gamma_{\rm Ca}^w \simeq 0.4 \rm{nm}^{-2}$,
...
analyzed from the ECC-lipids model simulation with 1 M concentration of NaCl are
...
\todo{It might be also better to do the analysis from ECC-lipids simulation with concentration closer
