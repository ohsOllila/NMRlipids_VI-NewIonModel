...
\begin{table}[tb!]
  \caption{Bulk concentrations of Ca$^{2+}$ ($C_{ion}$), relative surface excess of calcium with respect to water ($\Gamma_{Ca}^{\rm water}$),
    ...
    in different POPC bilayer models. All systems have the same molar concentration of Ca$^{2+}$ with respect to water ($C_{ion}'$=350 mM).
  \label{tab:binding}}
