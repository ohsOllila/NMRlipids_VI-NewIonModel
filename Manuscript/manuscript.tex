...
In general, scaling down the partial charges reduced the ion binding affinity.
...
Notice that former concentration was used by Catte et al.~\cite{catte16}.
...
with parameters from Refs. \citenum{martinek17, Pluharova2014}. Scaled charges and Lennart-Jones radii for atoms
...
\begin{figure}[tb!]
  ...
  \caption{\label{simVSexpNOions}
    ...
    the ECC-lipids models compared with experiments~\cite{kucerka11} at {\color{red}??K}.
...
\begin{figure}[htb!]
  ...
  \caption{\label{fig:delta_ordPar_CaCl}
    ...
    simulation with Lipid14 and ECC-ions due to the unconverged densities  (shown if Fig.~\ref{fig:cacl-dens}) in too 
