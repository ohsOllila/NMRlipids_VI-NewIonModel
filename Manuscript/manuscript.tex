...
thus the ion contacts with both oxygen moieties may be inter or intra molecular
...
The same experimental data for the lipid headgroup order parameters
used in this work to validate the simulation models in Fig. \ref{fig:delta_ordPar_CaCl},
has been previous interpreted by using simple binding models to determine the
binding constants and stoichimetry of \ce{Ca^{2+}} binding to PC lipid
bilayers~\cite{altenbach84,macdonald87}. The experimental data was best
...
the previously used simple binding models. To directly evaluate the
...
the probabilities for the complexes with stoichimetries of 1:1~(30\%)~and
...
\todo{This experimental estimate is actually for the residence time of Calcium
  ion at the individual PC lipid. This section is to be finished when the analysis details
