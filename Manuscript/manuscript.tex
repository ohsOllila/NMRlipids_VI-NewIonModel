...
the {\it total} dielectric constant, the electronic polarizability part can be considered to be constant
...
The quality of the model in terms of ion binding is measured by directly
...
As a starting point we used the parameters of Lipid14~\cite{dickson14} force field,
available in Gromacs format at \citenum{lipid14files}, because they apparently give the most
...
To find the best scaling factor to reproduce the ion binding affinity,
we explored the above discussed scaling factor parameter space, $f_q \in (0.75, 1.0)$,
and compared the results to the available NMR data~\cite{akutsu81,altenbach84,scherer89}.
