...
are shown in Fig.~\ref{fig:delta_ordPar_CaCl} and S\ref{fig:delta_ordPar_NaCl}
...
show a good agreement with experiments in Fig.~\ref{fig:delta_ordPar_CaCl} and S\ref{fig:delta_ordPar_NaCl}.
