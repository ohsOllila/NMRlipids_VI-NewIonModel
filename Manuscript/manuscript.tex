...
%  \includegraphics[width=3.6cm]{../Fig/volmap_resid10_Ca_Cl_sn2Cent.png}
  \caption{\label{fig:volmaps}
      Isocontours of spatial number density of \ce{Ca^{2+}} (cyan, 0.0015~\AA$^{-3}$) 
      and POPC carbonyl oxygen atoms (red, 0.0075~\AA$^{-3}$). 
      Calcium cations localize mostly around phosphate oxygens.
