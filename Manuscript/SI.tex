...
In order to demonstrate that ECC can be applied also to other than Lipid14 model,
...
radius. Changes of the headgroup order parameters as a function of added ions
...
lower than the experimental value (64.3 $\AA^2$). 
