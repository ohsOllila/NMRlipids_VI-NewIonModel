...
\ce{Ca^{2+}} to form complexes with 1-3 lipids observed in the main text is,
...
\begin{figure}[!h]
  ...
  \caption{\label{fig:hist_residence_times}
   ...
   Both simulations had the same concentration of \ce{CaCl_2} respect to water ($C_w$= 450~mM).
