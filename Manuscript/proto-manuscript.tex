...
\todo{SAMULI: I do not fully understand the end of this paragraph}
If such charges are obtained in an implicit solvent, 
they vary the most for the polar moieties \cite{maiejewski14}. 
...
\todo{SAMULI: I tried to repeat this calculation but I was not able to get 0.8.
...
One possible example is to adress the discourse on the stoichiometry of \ce{Ca^{2+}} binding 
...
\todo{Analyze stoichiometry for \ce{Na^+}, \ce{Ca^{2+}}, their interaction energies with the lipid membrane, 
etc, and finalize the discussion after these results.}
