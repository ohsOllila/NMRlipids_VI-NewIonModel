...
the part of dielectric response only due to electrons, and it is approximately $\epsilon _{el} \approx 2$ for almost any biomaterial that exists in living cells. 
