...
CALC_FORM_FACTOR=/mnt/ssd/scaledip/scripts/MATCH/scratch/report/calc_FORM_FACTOR.sh
REPORT_TEMPLATE=/mnt/ssd/scaledip/scripts/MATCH/scratch/report/report.tex
CALC_ORDER_PARAMETERS=/mnt/ssd/scaledip/scripts/MATCH/scratch/report/calc_ORDER_PARAMETERS.sh
GRO_OP=/mnt/ssd/scaledip/scripts/MATCH/scratch/report/gro_OP.awk
